...
describe('<Gallery />', () => {
  it('should render thumbnails as buttons', () => {
    ...
    expect(
      screen.getByRole('button', { name: `Thumb - ${mockItems[0].label}` })
    ).toHaveAttribute('src', mockItems[0].src)

    expect(
      screen.getByRole('button', { name: `Thumb - ${mockItems[1].label}` })
  ...
  it('should handle close modal when type esc key', () => {
